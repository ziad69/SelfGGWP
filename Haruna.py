...
helpMessage =""" SelfBot Ziad
||=====  P U B L I C  =====||
 
<==> Creator = Melihat Pembuat Bot
<==> Haruna say = Mengikuti Apa Yang DiKatakan
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks For Add,Senpai. Owner : line://ti/p/~anaichiro",
    "lang":"JP",
    "comment":"Thanks For Add,Senpai. Owner : line://ti/p/~anaichirp",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
				...
				if msg.from_ in admin:
					...
					kk.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚??∫√£¬Å¬Æ√£∆í‚??î√£∆í¬¨√£‚??ö¬º√£∆í¬≥√£∆íÀ??","Gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					...
					msg.text = None
					cl.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚??∫√£¬Å¬Æ√£∆í‚??î√£∆í¬¨√£‚??ö¬º√£∆í¬≥√£∆íÀ??","Cv1 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					ki.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚??∫√£¬Å¬Æ√£∆í‚??î√£∆í¬¨√£‚??ö¬º√£∆í¬≥√£∆íÀ??","Cv2 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kk.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚??∫√£¬Å¬Æ√£∆í‚??î√£∆í¬¨√£‚??ö¬º√£∆í¬≥√£∆íÀ??","Cv3 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kc.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚??∫√£¬Å¬Æ√£∆í‚??î√£∆í¬¨√£‚??ö¬º√£∆í¬≥√£∆íÀ??","All gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
              ...
              if msg.from_ in admin:
                if wait["ProtectQR"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["√©‚Ç¨¬£√ß¬µ¬°√•‚??¶À??:√£‚Äö¬™√£∆í¬??","K on","Contact on","√©¬°¬Ø√ß¬§¬∫√Ø¬º≈°√©‚Äì‚????"]:
				if msg.from_ in admin:
					if wait["contact"] == True:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["√©‚Ç¨¬£√ß¬µ¬°√•‚??¶À??:√£‚Äö¬™√£∆í‚????","K off","Contact off","√©¬°¬Ø√ß¬§¬∫√Ø¬º≈°√©‚Äî≈??"]:
				if msg.from_ in admin:
					if wait["contact"] == False:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["√®‚Ä°¬™√•‚??π‚??¢√•¬è‚??ö√•≈?? :√£‚Äö¬™√£∆í¬??","Join on","Auto join:on","√®‚Ä°¬™√•‚??π‚??¢√•¬è∆í√•≈?? √Ø¬º≈°√©‚Äì‚????"]:
				if msg.from_ in admin:
					if wait["autoJoin"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["√®‚Ä°¬™√•‚??π‚??¢√•¬è‚??ö√•≈?? :√£‚Äö¬™√£∆í‚????","Join off","Auto join:off","√®‚Ä°¬™√•‚??π‚??¢√•¬è∆í√•≈?? √Ø¬º≈°√©‚Äî≈??"]:
				if msg.from_ in admin:
					...
					try:
						...
						if strnum == "off":
							...
							if wait["lang"] == "JP":
								...
								cl.sendText(msg.to,"√•‚Ä¶¬≥√§¬∫‚??†√©‚??ö‚Ç¨√®¬Ø¬∑√¶‚Äπ‚??ô√ß¬ª¬ù√£‚Ç¨‚Äö√®¬¶¬Å√¶‚??î¬∂√•¬º‚Ç¨√®¬Ø¬∑√¶≈í‚Ä°√•¬Æ≈°√§¬∫¬∫√¶‚??¢¬∞√•¬è‚??ò√©‚Ç¨¬Å")
						else:
							num =  int(strnum)
							...
							if wait["lang"] == "JP":
								...
								cl.sendText(msg.to,strnum + "√§¬Ω¬ø√§¬∫¬∫√§¬ª¬•√§¬∏‚Äπ√ß≈°‚??û√•¬∞¬è√ß¬ª‚??û√ß‚??ù¬®√®‚??°¬™√•≈†¬®√©‚??ö‚Ç¨√®¬Ø¬∑√¶‚Äπ‚??ô√ß¬ª¬??")
					except:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Value is wrong")
						else:
							cl.sendText(msg.to,"Bizarre ratings")
            elif msg.text in ["√•¬º¬∑√•ÀÜ¬∂√®‚Ä°¬™√•‚??π‚??¢√©‚Ç¨‚Ç¨√•‚??°¬??:√£‚Äö¬™√£∆í¬??","Leave on","Auto leave:on","√•¬º¬∑√•ÀÜ¬∂√®‚Ä°¬™√•‚??π‚??¢√©‚Ç¨‚Ç¨√•‚??°¬∫√Ø¬º≈°√©‚??ì‚????"]:
				if msg.from_ in admin:
					if wait["leaveRoom"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"√®¬¶¬Å√§¬∫‚Ä†√•¬º‚Ç¨√£‚Ç¨‚????")
            elif msg.text in ["√•¬º¬∑√•ÀÜ¬∂√®‚Ä°¬™√•‚??π‚??¢√©‚Ç¨‚Ç¨√•‚??°¬??:√£‚Äö¬™√£∆í‚????","Leave off","Auto leave:off","√•¬º¬∑√•ÀÜ¬∂√®‚Ä°¬™√•‚??π‚??¢√©‚Ç¨‚Ç¨√•‚??°¬∫√Ø¬º≈°√©‚??î≈??"]:
				if msg.from_ in admin:
					if wait["leaveRoom"] == False:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"already")
            elif msg.text in ["√•‚Ä¶¬±√¶≈ì‚????:√£‚Äö¬™√£∆í¬??","Share on","Share on"]:
				if msg.from_ in admin:
					if wait["timeline"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"√®¬¶¬Å√§¬∫‚Ä†√•¬º‚Ç¨√£‚Ç¨‚????")
            elif msg.text in ["√•‚Ä¶¬±√¶≈ì‚????:√£‚Äö¬™√£∆í‚????","Share off","Share off"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					...
					if album["result"]["items"] == []:
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"√ß‚Ä∫¬∏√•‚??†≈í√¶¬≤¬°√•≈ì¬®√£‚Ç¨‚Ä??")
					else:
						if wait["lang"] == "JP":
							mg = "The following is the target album"
						else:
							mg = "√§¬ª¬•√§¬∏‚Äπ√¶Àú¬Ø√•¬Ø¬π√®¬±¬°√ß≈°‚??û√ß‚??∫¬∏√•‚??†≈??"
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,str(i) + "√•ÀÜ √©‚Ñ¢¬§√§¬∫‚??†√§¬∫‚??π√ß≈°‚??û√ß‚??∫¬∏√•‚??†≈í√£‚Ç¨‚Ä??")
            elif msg.text in ["Group id","√ß¬æ¬§√ß¬µ‚Äû√•‚??¶¬®id"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,"√¶‚Äπ‚??ô√ß¬ª¬ù√§¬∫‚??†√•‚??¶¬®√©∆í¬®√ß≈°‚??û√©‚??ö‚Ç¨√®¬Ø¬∑√£‚Ç¨‚????")
            elif "album remove√¢‚Ä†‚????" in msg.text:
				if msg.from_ in admin:
					gid = msg.text.replace("album remove√¢‚Ä†‚????","")
					albums = cl.getAlbum(gid)["result"]["items"]
					i = 0
					if albums != []:
						for album in albums:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,str(i) + "√•ÀÜ √©‚Ñ¢¬§√§¬∫‚??†√§¬∫‚??π√ß≈°‚??û√ß‚??∫¬∏√•‚??†≈í√£‚Ç¨‚Ä??")
            elif msg.text in ["√®‚Ä°¬™√•‚??π‚??¢√®¬ø¬Ω√•≈?? :√£‚Äö¬™√£∆í¬??","Add on","Auto add:on","√®‚Ä°¬™√•‚??π‚??¢√®¬ø¬Ω√•≈?? √Ø¬º≈°√©‚Äì‚????"]:
				if msg.from_ in admin:
					if wait["autoAdd"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"√®¬¶¬Å√§¬∫‚Ä†√•¬º‚Ç¨√£‚Ç¨‚????")
            elif msg.text in ["√®‚Ä°¬™√•‚??π‚??¢√®¬ø¬Ω√•≈?? :√£‚Äö¬™√£∆í‚????","Add off","Auto add:off","√®‚Ä°¬™√•‚??π‚??¢√®¬ø¬Ω√•≈?? √Ø¬º≈°√©‚Äî≈??"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,"done√£‚Ç¨‚????")
            elif msg.text in ["Message","√®‚Ä°¬™√•‚??π‚??¢√®¬ø¬Ω√•≈?? √•‚Ä¢¬è√•‚Ç¨‚Ñ¢√®¬™≈æ√ß¬¢¬∫√®¬™¬??"]:
				if msg.from_ in admin:
					if wait["lang"] == "JP":
						cl.sendText(msg.to,"message change to\n\n" + wait["message"])
					else:
						cl.sendText(msg.to,"The automatic appending information is set as follows√£‚Ç¨‚??ö\n\n" + wait["message"])
				...
				if msg.from_ in admin:
					...
					if c in [""," ","\n",None]:
						...
						wait["comment"] = c
						cl.sendText(msg.to,"changed\n\n" + c)
            elif msg.text in ["√£‚Äö¬≥√£∆í¬°√£∆í¬≥√£∆íÀ??:√£‚Äö¬™√£∆í¬??","Comment on","Comment:on","√®‚Ä°¬™√•‚??π‚??¢√©¬¶‚??ì√?? ¬Å√ß‚Ä¢‚Ñ¢√®¬®‚Ç¨√Ø¬º≈°√©‚??ì‚????"]:
				if msg.from_ in admin:
					if wait["commentOn"] == True:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"√®¬¶¬Å√§¬∫‚Ä†√•¬º‚Ç¨√£‚Ç¨‚????")
            elif msg.text in ["√£‚Äö¬≥√£∆í¬°√£∆í¬≥√£∆íÀ??:√£‚Äö¬™√£∆í‚????","Comment on","Comment off","√®‚Ä°¬™√•‚??π‚??¢√©¬¶‚??ì√?? ¬Å√ß‚Ä¢‚Ñ¢√®¬®‚Ç¨√Ø¬º≈°√©‚??î≈??"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "An already read point has not been set.\n°∏set°πyou can send ?? read point will be created ??")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Hadir Senpai :3!!")
#-----------------------------------------------
            elif "Haru say " in msg.text:
					bctxt = msg.text.replace("Tob say ","")
					ki.sendText(msg.to,(bctxt))
#-----------------------------------------------
            elif msg.text in ["Creator"]:
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u6dc040137eac599ca446f80f45bbd93c"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ...
                    try:
                        ...
                        cover = ""
                    cl.sendText(msg.to,"Ini Foto Profilenya Senpai :3 ")
                    cl.sendImageWithURL(msg.to,Imoet)
                    if cover == "":
                        cl.sendText(msg.to,"User tidak memiliki cover atau sejenisnya")
                    else:
                        cl.sendText(msg.to,"Ini Cover Profilenya Senpai :3 ")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di Grup,Senpai :3")
					kk.sendText(msg.to,"Jangan nakal ya,Senpai :3")
#-----------------------------------------------
...
#------------------------------------------------------------------
				...
				if msg.from_ in admin:
					try:
						...
						cl.sendText(msg.to,"Error")
            elif "fakec√¢‚Ä†‚????" in msg.text:
				if msg.from_ in admin:
					try:
						source_str = 'abcdefghijklmnopqrstuvwxyz1234567890@:;./_][!&%$#)(=~^|'
						name = "".join([random.choice(source_str) for x in xrange(10)])
						anu = msg.text.replace("fakec√¢‚Ä†‚????","")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"%50C//5K Pc Ajon")
						print "DiLike"
					except:
							pass
				else:
